...
# Workers row
@onready var _lbl_workers: Label = $Content/Panel/VBox/WorkersRow/WorkersLabel
@onready var _lbl_dead:    Label = $Content/Panel/VBox/WorkersRow/DeadLabel
...
func _ready() -> void:
	...
	_drink_need_icon.material = drink_mat
