...
func _build_steps() -> void:
    _steps = [
        ...
        _me("Use WASD, arrows or the middle mouse button to pan the map.", "panned", Callable(), 1.0, true),
        _mc("Your goal is to grow your town to a population of 30."),
        _mc("Millville's current population: 0", func(): return _hud.get_workers_rect()),
        ...
        _mc("Without food and drink, your workers will starve.", func(): return _hud.get_food_drink_rect()),
        _mc("Without clothes and tools, they won't be able to continue producing.", func(): return _hud.get_clothing_tool_rect()),
        _mc("You have some time before it happens."),
        _meu("Start food production early. Good luck!", "food_hovered",
