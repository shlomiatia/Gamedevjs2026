...
var TOOLTIP_DATA := {
    "WoodcutterHut": {"display_name": WoodcutterHut.BUILDING_NAME, "cost": 1, "action": "produce", "output": [0]},
    "BuilderHut": {"display_name": BuilderHut.BUILDING_NAME, "cost": 1, "action": "train"},
    "Sawmill": {"display_name": Sawmill.BUILDING_NAME, "cost": 1, "action": "convert", "inputs": [0], "output": [1]},
    "AppleFarm": {"display_name": AppleFarm.BUILDING_NAME, "cost": 1, "action": "produce", "output": [2]},
    "CiderMill": {"display_name": CiderMill.BUILDING_NAME, "cost": 1, "action": "convert", "inputs": [2], "output": [3]},
    "SheepFarm": {"display_name": SheepFarm.BUILDING_NAME, "cost": 1, "action": "produce", "output": [12, 4]},
    "WoolMill": {"display_name": WoolMill.BUILDING_NAME, "cost": 1, "action": "convert", "inputs": [4], "output": [5]},
    "ClayPit": {"display_name": "Clay Pit", "cost": 1, "action": "produce", "output": [6]},
    "ClayKiln": {"display_name": ClayKiln.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [6, 0], "output": [7]},
    ...
    "SteelMill": {"display_name": SteelMill.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [9, 8], "output": [10]},
    "Toolsmith": {"display_name": Toolsmith.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [8, 10], "output": [11]},
    "Fromage": {"display_name": Fromage.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [12, 0], "output": [13]},
    "WheatFarm": {"display_name": WheatFarm.BUILDING_NAME, "cost": 1, "action": "produce", "output": [14]},
    "Gritsmill": {"display_name": Gritsmill.BUILDING_NAME, "cost": 1, "action": "convert", "inputs": [14], "output": [15]},
    "Bakery": {"display_name": Bakery.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [15, 0], "output": [16]},
    "Brewery": {"display_name": Brewery.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [14, 0], "output": [17]},
    "FishermanHut": {"display_name": FishermanHut.BUILDING_NAME, "cost": 1, "action": "produce", "output": [18]},
    "Smokehouse": {"display_name": Smokehouse.BUILDING_NAME, "cost": 7, "action": "convert", "inputs": [18, 0], "output": [19]},
    "FlaxFarm": {"display_name": FlaxFarm.BUILDING_NAME, "cost": 1, "action": "produce", "output": [20]},
    "WeavingMill": {"display_name": WeavingMill.BUILDING_NAME, "cost": 1, "action": "convert", "inputs": [20], "output": [21]},
}
