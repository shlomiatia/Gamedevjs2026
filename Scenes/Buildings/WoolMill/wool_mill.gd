...
const WoolMillerScene = preload("res://Scenes/Workers/WoolMiller/WoolMiller.tscn")
...
func on_placed(spawn_parent: Node2D, map: Map, coordination_manager: Node, _forest: Forest) -> void:
	...
	$Building.get_output_pile().setup(coordination_manager, CoordinationManager.ResourceType.CLOTHES)
...
func complete_construction() -> void:
	...
	var miller := WoolMillerScene.instantiate() as WoolMiller
