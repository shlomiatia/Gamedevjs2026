...
func complete_construction() -> void:
	...
	worker.setup(self, _map, _coordination_manager, BrickScene, CoordinationManager.ResourceType.CLAY, CoordinationManager.ResourceType.LOG, _output_pile, WORKER_NAME)
